...
export default async function WorkCasePage({
  ...
  return (
    <div className="relative min-h-screen bg-[#15110f]">
      ...
      <Link href="/work" className="fixed top-24 md:top-32 left-4 md:left-[2.5rem] z-[60] inline-flex items-center gap-2 text-white/50 hover:text-brand-orange transition-colors font-monument text-[10px] tracking-widest uppercase bg-black/40 backdrop-blur-md px-4 py-2 rounded-full border border-white/10">
